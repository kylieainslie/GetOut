copa<-function(data, annotation=NULL, annID,annName,save.path=NULL,diff=T, cpmtype="Mann-Whitney",cut=0.85,
...
#################
  ...
  copa = function(data) (quantile(data,cut,na.rm=T)-median(data,na.rm=T))/mad(data)
